...
namespace ga {
  ...
  void FindMaxCut::solve(){
	...
	cout<< "average: " << average << endl;
      ...
      ++iteration;
      if (sec > 170.0){
        writeResults2("test.txt", pop_size,crossover_method, mut_prob, converge_mut_prob, crossover_prob );
	writeResult("ktest.txt");
	    break; 
      }
